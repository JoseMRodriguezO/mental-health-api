...
JournalEntry.create(user_id: "1", title: "Feeling Overwhelmed Today", content: "oday has been a tough day for me. I woke up feeling tired and drained, and as the day went on, I found myself feeling more and more overwhelmed. I have a lot on my plate right now with work and personal commitments, and it feels like there aren't enough hours in the day to get everything done.
...
Mood.create(user_id: "2", mood_type: "anxious", mood_intensity: "high")
JournalEntry.create(user_id: "3", title: "Grateful for a Wonderful Day", content: "Today has been an amazing day! I woke up feeling refreshed and energized, and everything seemed to fall into place. I had a productive day at work, and I received some positive feedback from my boss, which made me feel really good about my work.
